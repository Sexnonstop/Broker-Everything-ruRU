...
------ Guild ------
	...
	L["Enable/Disable the display of Guild Reputation in the Guild data broker tooltip."] = "Вкл/откл отображение репутации Гильдии в подсказке."
	...
	L["Show realm names behind guild and character names. Guilds and characters from connected-realms gets an asterisk behind the names if this option is unchecked."] = "Отображать название сервера.";
	L["Show zone"] = "Локация";
	L["Show current zone from guild members"] = "Отображать текущее местонахождение игрока.";
	L["Show notes"] = "Заметки";
	L["Show notes from guild members"] = "Отображать заметки игрока.";
	L["Show officer notes"] = "Офиц.заметки";
	L["Show officer notes from guild members. (This option will be ignored if you have not permission to read the officer notes)"] = "Отображать заметки игрока.";
	L["Show rank"] = "Звание";
	L["Show rank name from guild members"] = "Отображать звание игрока.";
	L["Show professions"] = "Профессии";
	L["Show professions from guild members"] = "Отображать профессии игрока.";
	L["Show applicants"] = "Кандидаты";
	L["Show applicants in broker and tooltip"] = "Отображать желающих вступить в Гильдию.";
	...
	L["Show mobile chatter in broker"] = "Число игроков с моб.подкл.";
	L["Show count of mobile chatter in broker button"] = "Отображать на кнопке число игров с мобильным подключением.";
